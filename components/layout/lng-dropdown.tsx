    ...
    <div className="relative inline-block text-left">
              ...
              return (
                <Link
                  ...
                  className={`relative flex w-full items-center justify-start space-x-2 rounded-md p-2 text-left text-sm transition-all duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 ${
                    locale === props.lng ? "cursor-not-allowed bg-gray-100 dark:bg-gray-700" : ""
                  }`}
                >
      ...
      >
        <button
          ...
          className="flex h-8 w-8 mr-2 items-center justify-center overflow-hidden rounded-full transition-all duration-75 focus:outline-none active:scale-95 sm:h-9 sm:w-9"
        >
